...
**redeem** is an R package for the estimation of **Durational Event
Models (DEM)** and **Relational Event Models (REM)**. It features a
scalable block-coordinate ascent algorithm designed to handle
